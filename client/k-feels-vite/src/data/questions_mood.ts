...
export const questionsMood: Question[] = [
  {
    ...
    options: [
      ...
      { answer: "Eat ramen and pretend I’m the main character", tag: "adventurous"}
    ],
  },
  {
    id: 2,
  ...
  },
  {
    ...
    options: [
      { answer: "Pretend I didn’t notice but secretly scream inside", tag: "romantic"},
  ...
  },
  {
    ...
    options: [
      ...
      { answer: "Summoning sad rain whenever I’m dramatic", tag: "melancholic"},
